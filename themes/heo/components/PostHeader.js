  ...
  return (
    <div
      ...
      <div
        ...
        <div
          id='post-info'
          className='z-10 w-full max-w-2xl px-5 text-white bg-black/20 backdrop-blur-sm p-6 rounded-xl shadow-lg'>
            {/* 网课部分 */}
            <div className='text-center text-2xl font-bold mb-4'>网课</div>
            <div className='flex flex-col space-y-3'>
                <div className='flex justify-between items-center'>
                    <div className='w-1/3'>口语</div>
                    <div className='w-1/3 text-center text-yellow-400 text-xl font-bold'>100元/月</div>
                    <div className='w-1/3 text-right text-sm opacity-80'>1小时/天 (每周1-5)</div>
                </div>
                <div className='flex justify-between items-center'>
                    <div className='w-1/3'>HSK</div>
                    <div className='w-1/3 text-center text-yellow-400 text-xl font-bold'>150元/月</div>
                    <div className='w-1/3 text-right text-sm opacity-80'>3小时/天 (周1-6)</div>
                </div>
            </div>
            ...
            <div className='flex flex-col space-y-3'>
                <div className='flex justify-between items-center'>
                    <div className='w-1/3'>口语</div>
                    <div className='w-1/3 text-center text-green-400 text-xl font-bold'>200元/月</div>
                    <div className='w-1/3 text-right text-sm opacity-80'>2小时/天 (周1-6)</div>
                </div>
                <div className='flex justify-between items-center'>
                    <div className='w-1/3'>HSK</div>
                    <div className='w-1/3 text-center text-green-400 text-xl font-bold'>200元/月</div>
