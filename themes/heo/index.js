// themes/heo/index.js (最终美化版，布局调整，图片背景按钮)
...
const QuickAccessGrid = () => {
    ...
    return (
        <div className='pt-4 px-5'> {/* 减少顶部间距 */}
            <div className='grid grid-cols-3 gap-2'> {/* 减小按钮间隙 */}
...
/**
 * 学习工具功能区 (使用 FeatureCard)
 */
const StudyToolsGrid = () => {
    const functions = [
        { title: '字典', subtitle: '在线查询', url: '/words', img: '/images/tool-dict.jpg' },
...
const RecruitmentCard = () => {
    ...
    const [imageUrl, setImageUrl] = useState(recruitmentImages[0]);
    useEffect(() => {
        setImageUrl(recruitmentImages[Math.floor(Math.random() * recruitmentImages.length)]);
    }, []);
