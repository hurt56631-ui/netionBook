...
const LayoutBase = props => {
  ...
  return (
    <div
      ...
      {/* --- 关键修改 2：在页脚上方渲染 HomepagePriceInfo 组件 (仅在首页显示) --- */}
      {isIndex && <HomepagePriceInfo />}
      {/* --- 修改结束 --- */}
            ...
            <article
              ...
              {post?.type === 'Post' && (
                <div className='px-5'>
                  ...
                  <div className='my-4'>
                    <SmartLink href='/jobs'>
                      <LazyImage src='/images/recruitment-banner.png' alt='招聘信息' className='w-full h-auto rounded-xl shadow-md transform hover:scale-105 transition-transform duration-200' />
                    </SmartLink>
                  </div>
                </div>
              )}
