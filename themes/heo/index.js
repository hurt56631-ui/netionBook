...
const LayoutBase = props => {
  ...
  return (
    <div
      id='theme-heo'
      className={`${siteConfig('FONT_STYLE')} app-container h-full min-h-screen flex flex-col scroll-smooth`}>
      <Style />
      {headerSlot}
      <main
        id='wrapper-outer'
        className={`w-full ${maxWidth} mx-auto relative md:px-5 flex-grow`}>
        <div
          id='container-inner'
...
// --- 新增：全屏、可滚动、支持多级分类的模态框 (Modal) 组件 ---
const FunctionModal = ({ title, description, categories }) => {
    return (
        <div className="function-modal-container fixed inset-0 z-50 flex flex-col bg-white/70 dark:bg-black/70 backdrop-blur-lg p-4">
            ...
            <div className="flex-grow overflow-y-auto space-y-6 pb-20">
                {categories.map((category, index) => (
                    <div key={index} className="function-category-card">
                        <div style={{ backgroundImage: `url('/images/${category.background}')` }} className="category-background"></div>
                        <div className="category-overlay"></div>
                        <h3 className="category-title">{category.title}</h3>
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                            {category.items.map((item, itemIndex) => (
                                <SmartLink key={itemIndex} href={item.url} className="category-item-link">
    ...
    return (
        <>
            <button
                ...
                className='function-button group'
            >
...
const quickAccessData = {
    报名课程: {
        title: "报名课程", description: "结合中缅教学方案，高效学习中文，欢迎联系我们获取专属学习方案。",
        categories: [
            { title: "联系方式", background: 'baoming.jpg', items: [
    ...
    找工作: {
        title: "找工作", description: "我们与上百家工厂长期合作，为您提供各地的中文相关工作岗位！",
        categories: [
            { title: "地区", background: 'zhaogongzuo.jpg', items: [
                    { title: '仰光地区招聘', url: '/jobs/yangon' },
                    { title: '泰国地区招聘', url: '/jobs/thailand' },
                    { title: '新加坡地区招聘', url: '/jobs/singapore' },
                    { title: '马来西亚招聘', url: '/jobs/malaysia' },
                    { title: '中国地区招聘', url: '/jobs/china' },
                ]
            },
            { title: "操作", background: 'jianli.jpg', items: [{ title: '发布简历/咨询', url: '/resume' }] }
        ]
    },
    试看课程: {
        title: "试看课程", description: "免费体验我们的教学质量，即刻开始您的中文学习之旅！",
        categories: [
            { title: "课程类型", background: 'shikan.jpg', items: [
...
const studyToolsData = {
    title: "学习工具", description: "丰富的在线工具，助你中文学习更上一层楼。",
    categories: [
        { title: "HSK 备考", background: 'hsk.jpg', items: [
        ...
        { title: "语法学习", background: 'yufa.jpg', items: [
        ...
        { title: "拼音学习", background: 'pinyin.jpg', items: [
        ...
        { title: "在线工具", background: 'gongju.jpg', items: [
                { title: '汉典', url: 'https://www.zdic.net/' },
                { title: 'Pleco', url: 'https://www.pleco.com/' },
                { title: '萌典', url: 'https://www.moedict.tw/' },
...
const LayoutIndex = props => {
  return (
    <div id='post-outer-wrapper' className='px-5 md:px-0'>
      ...
      <div className="py-4">
        <h2 className="text-2xl font-bold mb-4 text-center dark:text-white">快捷入口</h2>
      ...
      <ModalFunctionButton 
        ...
        modalContent={<FunctionModal {...studyToolsData} />}
      />
...
// ... (LayoutPostList, LayoutSearch, LayoutArchive, etc., and export statements remain unchanged)
